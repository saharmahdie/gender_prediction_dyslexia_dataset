...
files_logReg =glob.glob(r"C:\Users\Rishabh Haria\Desktop\Eye biometric\Cleaned_Gender_Dsylexia_branch\schau_mir_in_die_augen\scripts\results\Gender_prediction_paper_accuracy\predict_MF_with_dyslexic_gender_prediction_features_trainRatio_0.8\featuers_score_MD19+FD19+MH0+FH0\BOTH_AVG_FEAT\gender-selection\logReg\IVT_50\FEATS_4\*.json")
# files_rf = glob.glob("./results/Gender_prediction_paper_accuracy/predict_MF_with_mixed_predict_gender_trainRatio_0.8/featuers_score_MD9+FD9+MH9+FH9/BOTH_AVG_FEAT/gender-selection/rf/IVT_50/FEATS_4/*.json")
# files_rbfn = glob.glob("./results/Gender_prediction_paper_accuracy/predict_MF_with_mixed_predict_gender_trainRatio_0.8/featuers_score_MD9+FD9+MH9+FH9/BOTH_AVG_FEAT/gender-selection/rbfn/IVT_50/FEATS_4/*.json")
# files_svm = glob.glob("./results/Gender_prediction_paper_accuracy/predict_MF_with_mixed_predict_gender_trainRatio_0.8/featuers_score_MD9+FD9+MH9+FH9/BOTH_AVG_FEAT/gender-selection/svm/IVT_50/FEATS_4/*.json")
# files_naive = glob.glob("./results/Gender_prediction_paper_accuracy/predict_MF_with_mixed_predict_gender_trainRatio_0.8/featuers_score_MD9+FD9+MH9+FH9/BOTH_AVG_FEAT/gender-selection/naive_bayes/IVT_50/FEATS_4/*.json")
